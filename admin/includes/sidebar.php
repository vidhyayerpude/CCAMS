    ...
    <a href="dashboard.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">CCAMS | Admin </span>
    </a>
    <div class="sidebar">
...
<!--Practice Areas--->
   <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
                <a href="new-ccapplication.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New Application</p>
                </a>
              </li>
           ...
           <li class="nav-item">
                <a href="approved-ccapplication.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p> Approved Application</p>
                </a>
              </li>
<li class="nav-item">
                <a href="rejected-ccapplication.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p> Rejected Application</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="all-ccapplication.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p> All Application</p>
                </a>
              </li>
